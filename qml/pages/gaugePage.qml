...
Item {
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            ShaderEffect {
                ...
                property real angle: ((1.6 * Math.PI * (gauge1.value) / (gauge1.maximumValue - gauge1.minimumValue)) + Math.PI * (0.8 - (1.6 * gauge1.maximumValue / (gauge1.maximumValue - gauge1.minimumValue))))
                readonly property real Math_PI: 3.1415926535897932384626433832795
                vertexShader: "
	...
	Rectangle {
		...
		ShaderEffect {
			...
			opacity: 0.85  
			property real angleBase: -Math.PI * 0.80
			property real angle: ((1.6 * Math.PI * (gauge2.value) / (gauge2.maximumValue - gauge2.minimumValue)) + Math.PI * (0.8 - (1.6 * gauge2.maximumValue / (gauge2.maximumValue - gauge2.minimumValue))))
			readonly property real Math_PI: 3.1415926535897932384626433832795
			vertexShader: "
			uniform highp mat4 qt_Matrix;
			attribute highp vec4 qt_Vertex;
	...
	Rectangle {
		...
		ShaderEffect {
			...
			opacity: 0.95  
			property real angleBase: -Math.PI * 0.80
			property real angle: ((1.6 * Math.PI * (gauge3.value) / (gauge3.maximumValue - gauge3.minimumValue)) + Math.PI * (0.8 - (1.6 * gauge3.maximumValue / (gauge3.maximumValue - gauge3.minimumValue)))
			)
			readonly property real Math_PI: 3.1415926535897932384626433832795
			vertexShader: "
			uniform highp mat4 qt_Matrix;
	...
	Connections {
		target: backend
		// Fungsi yang menghubungkan nilai dari backend ke elemen-elemen UI
