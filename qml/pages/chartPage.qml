    ...
    ChartView {
        ...
        Timer {
            ...
            onTriggered: {
                ...
                tempbox1.value = backend.get_parameter('pressure_a', 'maximum_display')
                flowbox.value = backend.get_parameter('flow', 'maximum_display')
                boxcommon.value = backend.get_parameter('common', 'maximum_display')
                boxinlet.value = backend.get_parameter('common_ma', 'maximum_display')
