    ...
    Rectangle {
        ...
        Rectangle {
            ...
            ShaderEffect {
                ...
                anchors.fill: parent
                opacity: 0.85
                property real angleBase: -Math.PI * 0.80
                property real angle: ((1.6 * Math.PI * (gauge4.value) / (gauge4.maximumValue - gauge4.minimumValue)) + Math.PI * (0.8 - (1.6 * gauge4.maximumValue / (gauge4.maximumValue - gauge4.minimumValue))))
                readonly property real Math.PI: 3.1415926535897932384626433832795
                vertexShader: "
            ...
            CircularGauge {
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        font.pixelSize: Math.max(6, parent.width * 0.25)
                        color:"#e5e5e5"
                    }
                }
                Rectangle {
		...
		Rectangle {
			...
			ShaderEffect {
				...
				opacity: 0.95
				property real angleBase: -Math.PI * 0.80
				property real angle: ((1.6 * Math.PI * (gauge5.value) / (gauge5.maximumValue - gauge5.minimumValue)) + Math.PI * (0.8 - (1.6 * gauge5.maximumValue / (gauge5.maximumValue - gauge5.minimumValue))))
				readonly property real Math.PI: 3.1415926535897932384626433832795
		...
		Rectangle {
			...
			ShaderEffect {
				...
				opacity: 0.85
				property real angleBase: -Math.PI * 0.80
				property real angle: ((1.6 * Math.PI * (gauge6.value) / (gauge6.maximumValue - gauge6.minimumValue)) + Math.PI * (0.8 - (1.6 * gauge6.maximumValue / (gauge6.maximumValue - gauge6.minimumValue))))
				readonly property real Math.PI: 3.1415926535897932384626433832795
		...
		Rectangle {
			...
			ShaderEffect {
				...
				opacity: 0.95
				property real angleBase: -Math.PI * 0.80
				property real angle: ((1.6 * Math.PI * (gauge8.value) / (gauge8.maximumValue - gauge8.minimumValue)) + Math.PI * (0.8 - (1.6 * gauge8.maximumValue / (gauge8.maximumValue - gauge8.minimumValue))))
				readonly property real Math.PI: 3.1415926535897932384626433832795
		...
		Rectangle {
			...
			// Shader effect untuk membuat gauge berbasis gradien
			ShaderEffect {
				id: shader13
				anchors.fill: parent
				opacity: 0.85
				property real angleBase: -Math.PI * 0.80
				property real angle: ((1.6 * Math.PI * (gauge13.value) / (gauge13.maximumValue - gauge13.minimumValue)) + Math.PI * (0.8 - (1.6 * gauge13.maximumValue / (gauge13.maximumValue - gauge13.minimumValue))))
				readonly property real Math.PI: 3.1415926535897932384626433832795
		...
		Rectangle {
			...
			// Shader effect untuk memberikan efek gradien pada gauge
			ShaderEffect {
				id: shader9
				anchors.fill: parent
				opacity: 0.85
				property real angleBase: -Math.PI * 0.80
				property real angle: ((1.6 * Math.PI * (gauge9.value) / (gauge9.maximumValue - gauge9.minimumValue)) + Math.PI * (0.8 - (1.6 * gauge9.maximumValue / (gauge9.maximumValue - gauge9.minimumValue))))
				readonly property real Math.PI: 3.1415926535897932384626433832795
		...
		Rectangle {
			...
			ShaderEffect {
				...
				opacity: 0.95
				property real angleBase: -Math.PI * 0.80
				property real angle: ((1.6 * Math.PI * (gauge10.value) / (gauge10.maximumValue - gauge10.minimumValue)) + Math.PI * (0.8 - (1.6 * gauge10.maximumValue / (gauge10.maximumValue - gauge10.minimumValue))))
				readonly property real Math.PI: 3.1415926535897932384626433832795
		...
		Rectangle {
			...
			ShaderEffect {
				id: shader11
				property real angleBase: -Math.PI * 0.80
				property real angle: ((1.6 * Math.PI * (gauge11.value) / (gauge11.maximumValue - gauge11.minimumValue)) + Math.PI * (0.8 - (1.6 * gauge11.maximumValue / (gauge11.maximumValue - gauge11.minimumValue))))
		...
		Rectangle {
			...
			ShaderEffect {
				...
				opacity: 0.95
				property real angleBase: -Math.PI * 0.80
				property real angle: ((1.6 * Math.PI * (gauge12.value) / (gauge12.maximumValue - gauge12.minimumValue)) + Math.PI * (0.8 - (1.6 * gauge12.maximumValue / (gauge12.maximumValue - gauge12.minimumValue)))
				)
				property real pi: Math.PI
